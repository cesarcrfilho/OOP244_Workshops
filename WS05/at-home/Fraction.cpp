...
namespace sict {
    ...
    Fraction Fraction::operator * (const Fraction& rhs) {
        ...
        if (fractionIsValid(m_numerator, m_denominator) && fractionIsValid(rhs.m_numerator, rhs.m_denominator) && !isEmpty() && !rhs.isEmpty()) {
            // set the result
            result.set(m_numerator * rhs.m_numerator, m_denominator * rhs.m_denominator);
            result.reduce(); // reduce the fraction
        }
        return result;
    }
    ...
    bool Fraction::operator == (const Fraction& rhs) const {
        ...
        if (fractionIsValid(m_numerator, m_denominator) && fractionIsValid(rhs.m_numerator, rhs.m_denominator) && m_numerator == rhs.m_numerator && m_denominator == rhs.m_denominator && !isEmpty() && !rhs.isEmpty()) {
            result = true;
        }
        return result;
    }
